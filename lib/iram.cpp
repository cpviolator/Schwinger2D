...
void reorder(std::vector<field<Complex> *> kSpace, std::vector<Complex> evals, std::vector<double> residua, int n_kr, int spectrum) {
...
void qriteration(MatrixXcd &Rmat, MatrixXcd &Qmat, const int n_kr, const double tol)
{  
...
int qrFromUpperHess(MatrixXcd &upperHess, MatrixXcd &Qmat, std::vector<Complex> &evals, std::vector<double> &residua, const double beta, const int n_kr, const double tol)
{
